...
export class Services extends Component {
    ...
    read = () => {
        axios.get('services/all').then(res => {
            if (res.status === 200) {
                this.setState({ services: res.data, loader:false })
            }
        })
    }
    render() {
        const {loader,services } = this.state;
        return (
            <div>
                <div className="toolbar">
                    <div className="row align-items-center h-100">
                        <div className="col">
                            <div className="h5 m-0">Manage Services</div>
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-md">
                                            <div className="row align-items-center gutters-5">
                                                <div className="col-md-12 col text-right text-md-left"><div className="text-black-50">Serive</div></div>
